...
app.config['MAIL_DEFAULT_SENDER'] = os.environ.get('MAIL_DEFAULT_SENDER', 'riyue1808@gmail.com')
...
@app.route('/google1109cbc1c7519685.html')
def google_verify():
    return send_from_directory('.', 'google1109cbc1c7519685.html')
